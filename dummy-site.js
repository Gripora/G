...
function header(){return `<header class="site-header">${logo()}<nav class="desktop-nav"><a href="dummy.html#categories">Gloves</a><a href="private-label-oem.html">Private Label / OEM</a><a href="custom-glove-development.html">Custom Development</a><a href="dummy.html#about">About</a></nav><a class="header-cta" href="mailto:ibtesam@griporagloves.com">Start a project</a></header>`}
function footer(){return `<footer><div>${logo(true)}</div><div class="footer-links"><a href="dummy.html#categories">Categories</a><a href="private-label-oem.html">Private Label / OEM</a><a href="custom-glove-development.html">Custom Development</a><a href="mailto:ibtesam@griporagloves.com">ibtesam@griporagloves.com</a></div><div class="footer-meta">© 2026 GRIPORA · Sialkot, Pakistan<br><span>Dummy redesign preview · live site unchanged.</span></div></footer>`}
